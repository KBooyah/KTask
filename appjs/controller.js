...
myApp.config(['$routeProvider', function($routeProvider) {
				...
				$routeProvider.when("/depts", {templateUrl: "partials/depts.html", controller: "deptsController"});
				$routeProvider.when("/depts/:dept_id", {templateUrl: "partials/deptview.html", controller: "deptsController"});
				$routeProvider.when("/research", {templateUrl: "partials/research.html", controller: "researchController"});
...
myApp.controller('deptsController',['$scope','$http','$routeParams','$location',function($scope,$http,$routeParams,$location){
